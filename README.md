...
[Earlier versions of the benchmarks](https://github.com/bertiqwerty/exmex/blob/1eceae3e363dce7362e081ae73333a5e0e2b8320/README.md#benchmarks-v0172) compared to [meval](https://docs.rs/meval/latest/meval/) and [fasteval](https://docs.rs/fasteval/latest/fasteval/). Both were measured to be significantly faster than Evalexpr. Exmex outperformed both of them in evaluation performance and was worse in parsing performance. Meval and Fasteval are not maintained anymore.
